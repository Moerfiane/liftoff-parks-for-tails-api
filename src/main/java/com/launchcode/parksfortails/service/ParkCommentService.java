package com.launchcode.parksfortails.service;

import com.launchcode.parksfortails.models.ParkComment;
import com.launchcode.parksfortails.data.ParkCommentRepository;
...
public class ParkCommentService {
     ...
     */
    public void addComment(ParkComment comment, Long userId) {
